    ...
    <div class="flex justify-center gap-15 my-20 flex-wrap">
        <div class="card bg-gray-700 w-75 shadow-lg   my-10 transform transition duration-300 hover:scale-105 hover:shadow-2xl ">
            <div class="card-body ">
                <h2 class="card-title">Guru</h2>
                  <h1 class="text-2xl font-bold"><?php echo e($jml_guru); ?></h1>
            </div>
        </div>
        <div class="card bg-gray-700 w-75 shadow-lg  my-10 transform transition duration-300 hover:scale-105 hover:shadow-2xl ">
            <div class="card-body ">
        ...
        <div class="card bg-gray-700 w-75 shadow-lg  my-10 transform transition duration-300 hover:scale-105 hover:shadow-2xl ">
            <div class="card-body ">
                ...
                <h1 class="text-2xl font-bold"><?php echo e($jml_jurusan); ?></h1>
            </div>
        </div>
        <div class="card bg-gray-700 w-75 shadow-lg  my-10 transform transition duration-300 hover:scale-105 hover:shadow-2xl ">
            <div class="card-body ">
                <h2 class="card-title">Ekstrakulikuler</h2>
                <h1 class="text-2xl font-bold"><?php echo e($jml_eskul); ?></h1>
            </div>
        </div>
        <div class="card bg-gray-700 w-75 shadow-lg  my-10 transform transition duration-300 hover:scale-105 hover:shadow-2xl ">
            <div class="card-body ">
                <h2 class="card-title">Rombongan Belajar</h2>
                <h1 class="text-2xl font-bold"><?php echo e($jml_rombel); ?></h1>
            </div>
        </div>
    </div>
</section>
