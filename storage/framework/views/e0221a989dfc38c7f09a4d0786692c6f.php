        ...
        <nav class="container mx-auto px-6 py-3">
          <div class="flex items-center justify-between">
            ...
            <div class="hidden md:block">
              <ul class="flex items-center space-x-8">
                <li><a href="<?php echo e(route('admin')); ?>" class="text-white">Home</a></li>
          ...
          <div class="mobile-menu hidden md:hidden">
            <ul class="mt-4 space-y-4">
              <li><a href="<?php echo e(route('admin')); ?>" class="block px-4 py-2 text-white bg-gray-900 rounded">Home</a></li>
...
</html><?php /**PATH C:\laragon\www\websekolah\resources\views/layouts/layout.blade.php ENDPATH**/ ?>